...
exports.sendEmailVerificationCode = functions.https.onRequest(
  withCors(require('./handlers/emailVerificationHandlers').handleSendEmailVerificationCode),
)

exports.verifyEmailCode = functions.https.onRequest(
  withCors(require('./handlers/emailVerificationHandlers').handleVerifyEmailCode),
)
...
exports.sendAdminBroadcastEmail = functions.https.onRequest(
  withCors(require('./handlers/adminBroadcastEmailHandler').handleSendAdminBroadcastEmail),
)
