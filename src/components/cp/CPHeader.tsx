...
const menuCategories: NavCategory[] = [
  {
    ...
    items: [
      ...
      { href: '/flashquestoes', label: 'FlashQuestões com IA', auth: true },
      { href: '/edital-verticalizado', label: 'Edital Verticalizado', auth: true },
      { href: '/conteudo-completo', label: 'Conteúdo Completo', auth: true },
      { href: '/simulado', label: 'Simulado', auth: true },
      { href: '/treino-redacao', label: 'Treino Redação', auth: true },
      { href: '/calendario', label: 'Calendário de Progresso', auth: true },
      { href: '/mentoria', label: 'Mentoria', auth: true },
      { href: '/materia-revisada', label: 'Matéria Revisada', auth: true },
      { href: '/ranking-simulado', label: 'Ranking Simulado', auth: true },
      { href: '/guia-estudos', label: 'Guia de Estudos' },
