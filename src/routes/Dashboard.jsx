...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <p className="text-sm font-semibold uppercase tracking-wide text-alego-500 dark:text-alego-400">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <div 
            className="rounded-2xl p-6 shadow-sm border-2 border-alego-200 dark:border-alego-700"
            style={{
              backgroundColor: darkMode ? '#1e293b' : '#ffffff',
              color: darkMode ? '#f1f5f9' : '#1e293b'
            }}
          >
            <div className="flex items-start gap-4">
              <div className="rounded-full bg-alego-100 dark:bg-alego-900 p-3">
                <LightBulbIcon className="h-6 w-6 text-alego-600 dark:text-alego-400" />
              </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              <BookOpenIcon className="h-8 w-8 text-alego-500 dark:text-alego-400" />
              <p className="mt-2 text-sm uppercase tracking-wide text-slate-400 dark:text-slate-500">
                Favoritos
              </p>
              <p className="text-4xl font-black text-alego-700 dark:text-alego-300">
            ...
            >
              <ClockIcon className="h-8 w-8 text-alego-500 dark:text-alego-400" />
              <p className="mt-2 text-sm uppercase tracking-wide text-slate-400 dark:text-slate-500">
                Horas estudadas
              </p>
              <p className="text-4xl font-black text-alego-700 dark:text-alego-300">
            ...
            >
              <ChartBarIcon className="h-8 w-8 text-alego-500 dark:text-alego-400" />
              <p className="mt-2 text-sm uppercase tracking-wide text-slate-400 dark:text-slate-500">
                Progresso total
              </p>
              <p className="text-4xl font-black text-alego-700 dark:text-alego-300">
      ...
      >
        <h2 className="text-xl font-bold text-alego-700 dark:text-alego-300">Progresso por Matéria</h2>
